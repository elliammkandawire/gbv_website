    ...
    <div id="container" style="width: 100%;">
        <?php foreach($data as $item): ?>
            <div class="gallery w3-container">
                <a target="_blank" href="<?php echo base_url(); ?>assets\images\backgrounds\<?php echo $item->picture; ?>">
                    <img src="<?php echo base_url(); ?>assets\images\backgrounds\<?php echo $item->picture; ?>" alt="" style="object-fit: cover; height: 200px;" >
                </a>
