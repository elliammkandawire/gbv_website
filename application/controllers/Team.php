...
class Team extends BaseController {
	...
	public function addDefaultData(){
		$data=array(
			...
			"facebook_url"=>$this->removeHtmlTags($this->input->post("facebook_link")),
			"teams_group"=>$this->removeHtmlTags($this->input->post("teams_group")),
			"twitter_url"=>$this->removeHtmlTags($this->input->post("twitter_link"))
		);
